...
df1 = spark.read.csv('C:\\Users\\gamon\\Documents\\Data\Data_Big\\5-Hi-Level_Spark\\fb_live_thailand2.csv', header=True, inferSchema=True)
df2 = spark.read.csv('C:\\Users\\gamon\\Documents\\Data\Data_Big\\5-Hi-Level_Spark\\fb_live_thailand3.csv', header=True, inferSchema=True)

read_file = spark.read.format("csv") \
    .option("header", "true") \
    .load("C:\\Users\\gamon\\Documents\\Data\Data_Big\\5-Hi-Level_Spark\\fb_live_thailand.csv")
...
sqlDF1 = spark.read.format("csv") \
    .option("header", "true") \
    .load("C:\\Users\\gamon\\Documents\\Data\\Data_Big\\5-Hi-Level_Spark\\fb_live_thailand2.csv")

sqlDF2 = spark.read.format("csv") \
    .option("header", "true") \
    .load("C:\\Users\\gamon\\Documents\\Data\\Data_Big\\5-Hi-Level_Spark\\fb_live_thailand3.csv")
